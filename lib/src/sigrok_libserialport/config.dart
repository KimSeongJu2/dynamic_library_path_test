...
abstract class SerialPortConfig {
  ...
  /// @internal
  factory SerialPortConfig.fromAddress(int address) => _SerialPortConfigImpl.fromAddress(address);
...
typedef _SerialPortConfigGet = int Function(ffi.Pointer<sp_port_config> config, ffi.Pointer<ffi.Int> out);
typedef _SerialPortConfigGet32 = int Function(
  ffi.Pointer<sp_port_config> config,
  ffi.Pointer<ffi.Int32> out,
);
typedef _SerialPortConfigSet = int Function(ffi.Pointer<sp_port_config> config, int value);
...
class _SerialPortConfigImpl implements SerialPortConfig {
  ...
  _SerialPortConfigImpl.fromAddress(int address) : _config = ffi.Pointer<sp_port_config>.fromAddress(address);
  ...
  @override
  void setFlowControl(int value) => _set(dylib.sp_set_config_flowcontrol, value);
