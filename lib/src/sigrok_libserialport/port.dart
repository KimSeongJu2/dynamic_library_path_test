...
abstract class SerialPort {
  ...
  /// @internal
  factory SerialPort.fromAddress(int address) => _SerialPortImpl.fromAddress(address);
...
class _SerialPortImpl implements SerialPort {
  ...
  _SerialPortImpl.fromAddress(int address) : _port = ffi.Pointer<sp_port>.fromAddress(address);
  ...
  @override
  bool open({required int mode}) => dylib.sp_open(_port, mode) == sp_return.SP_OK;
